...
export function ZonaRestaurativa() {
  return (
    <div className="max-w-screen-xl mx-auto my-24 px-4 sm:px-6 lg:px-8">
      <div className="lg:col-start-1 lg:grid lg:w-full lg:grid-cols-2 lg:gap-x-8">
        ...
        <h2 className="mt-3 col-span-2  text-2xl font-semibold tracking-tight text-gray-100">
          ...
          <p className="mt-1">
            En cada área de Fundación Neuquén Oeste contamos con un protocolo concreto de acción para la gestión y prevención de conflictos orientado a una convivencia pacífica en el que todas las partes podemos desempeñarnos como agentes de restauración.
          </p>
        </div>
        ...
        <div className="lg:max-w-xl text-lg text-gray-400 text-balance">
          ...
          <p className="mt-1">
            Anhelamos que las Prácticas Restaurativas lleguen a cada organismo de la sociedad civil. Nos gustaría ser una referencia del impacto positivo que esta metodología tiene a la hora de promover una cultura proactiva donde la prevención y gestión saludable de los conflictos son el resultado de dinámicas vinculares empáticas, participativas y colaborativas.
          </p>
